...
%% check for trial_data
 ...
 %% check for practice_data

    try
        practice_data = evalin('base', 'practice_data');
    catch
        fprintf('There is no PRACTICE_DATA variable. You need to initialize the experiment.\n');
        practice_data = [];
    end
...
%% trial data
    ...
    average_trial_length = nanmean(trial_data.duration);
