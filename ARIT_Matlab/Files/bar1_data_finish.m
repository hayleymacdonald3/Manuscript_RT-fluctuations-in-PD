function [edata, trial_data] = bar1_data_finish(edata, trial_data)
...
%% fix columns
    ...
    trial_data = dataset_nominalize_fields(trial_data, ...
        {'stop_side', 'outcome'});
    trial_data = dataset_numericize_fields(trial_data, ...
